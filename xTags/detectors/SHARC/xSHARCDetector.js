    ...
    xtag.register('detector-SHARC', {
        ...
        methods: {
            'instantiateCells': function(){
                ...
                cellCoords['SHB05DP'] = [{x: -0.625*this.width + this.grid, y: -0.8*this.height + this.width/8*Math.tan(this.theta) + this.long/2}, 'tall'];
                cellCoords['SHB06DP'] = [{x: -0.625*this.width, y: -0.8*this.height + this.width/8*Math.tan(this.theta) + this.grid + this.short/2}, 'long'];
                cellCoords['SHB07DP'] = [{x: -0.625*this.width - this.grid, y: -0.8*this.height + this.width/8*Math.tan(this.theta) + this.long/2}, 'tall'];
                cellCoords['SHB08DP'] = [{x: -0.625*this.width, y: -0.8*this.height + this.width/8*Math.tan(this.theta) - this.grid + this.short/2}, 'long'];
                cellCoords['SHB05DN'] = [{x: -0.625*this.width + 2*this.grid, y: -0.8*this.height + this.width/8*Math.tan(this.theta) + this.long/2}, 'tall'];
                cellCoords['SHB06DN'] = [{x: -0.625*this.width, y: -0.8*this.height + this.width/8*Math.tan(this.theta) + 2*this.grid + this.short/2}, 'long'];
                cellCoords['SHB07DN'] = [{x: -0.625*this.width - 2*this.grid, y: -0.8*this.height + this.width/8*Math.tan(this.theta) + this.long/2}, 'tall'];
                cellCoords['SHB08DN'] = [{x: -0.625*this.width, y: -0.8*this.height + this.width/8*Math.tan(this.theta) - 2*this.grid + this.short/2}, 'long'];

        ...
        methods: {
            'instantiateCells': function(){
                var i, 
                    ...
                    downstreamSHQfrontCenterX = 0.625*this.width + this.grid,
                    downstreamSHQfrontCenterY = 0.8*this.height - (downstreamSHQfrontCenterX - 0.5*this.width)*Math.sin(theta),
                    downstreamSHQbackCenterX = 0.625*this.width + 2*this.grid,
                    downstreamSHQbackCenterY = 0.8*this.height - (downstreamSHQbackCenterX - 0.5*this.width)*Math.sin(theta),

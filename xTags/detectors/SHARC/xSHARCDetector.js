        ...
        methods: {
            'instantiateCells': function(){
                var i, 
                    ...
                    downstreamSHQfrontCenterX = -downstreamBoxCenterX + 3*this.grid,
                    downstreamSHQfrontCenterY = -downstreamBoxCenterY - 3*this.grid*Math.tan(this.theta),
                    downstreamSHQbackCenterX = -downstreamBoxCenterX + 4*this.grid,
                    downstreamSHQbackCenterY = -downstreamBoxCenterY - 4*this.grid*Math.tan(this.theta),

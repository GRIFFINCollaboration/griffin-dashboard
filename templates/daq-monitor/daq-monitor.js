...
console.log('repaint')
    ...
    createBarchart(
        ...
        'Digitizer ' + dataStore.ODB.DAQ.summary.digitizers.titles[digiCollectorIndex][digitizerFigureIndex] + ' Channels<br><b>Host: </b>' + '<a href="#" onclick="RedirectURL(ADC);return false;">'+ADC+'</a>', 'Channel', 'Hz'
    );    

...
console.log('repaint')
    ...
    createBarchart(
        ...
        'Digitizer ' + dataStore.ODB.DAQ.summary.digitizers.titles[digiCollectorIndex][digitizerFigureIndex] + ' Channels<br><b>Host: </b>' + '<a href="javascript:window.location=ADC;">'+ADC+'</a>', 'Channel', 'Hz'
    );    

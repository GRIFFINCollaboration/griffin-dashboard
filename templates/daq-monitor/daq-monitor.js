...
console.log('repaint')
    ...
    createBarchart(
        ...
        'Digitizer ' + dataStore.ODB.DAQ.summary.digitizers.titles[digiCollectorIndex][digitizerFigureIndex] + ' Channels<br><b>Host: </b>' + '<a href="javascript:window.location.href=ADC;">'+ADC+'</a>', 'Channel', 'Hz'
    );    

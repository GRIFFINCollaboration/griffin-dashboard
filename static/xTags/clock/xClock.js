        ...
        methods: {
            'updateForm' : function(payload){
                ...
                if(isMaster){
                    ...
                    document.getElementById('input#clockSidebarView2Label').setAttribute('style', 'display:inline-block');
                } else{
                    ...
                    document.getElementById('input#clockSidebarView2Label').setAttribute('style', 'display:none');
                }
